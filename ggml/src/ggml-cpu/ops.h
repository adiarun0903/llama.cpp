...
void ggml_compute_forward_turboq_attn_decode(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_turboq_attn_kcorr(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_turboq_recurrent_load(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_turboq_recurrent_store(const struct ggml_compute_params * params, struct ggml_tensor * dst);
